...
{
    internal static UInt128 ToUint128(this uint128 input)
    {
    ...
    public static UInt128 Combine(UInt128 one, UInt128 two)
    {
        unsafe
        {
            ...
            return ToUint128(xxHash128.ComputeHash(new Span<byte>(pointer,32),32));
        }
    }
    ...
    public static UInt128 Combine(UInt128 t1, UInt128 t2,UInt128 t3)
    {
        unsafe
        {
            ...
            return ToUint128(xxHash128.ComputeHash(new Span<byte>(pointer,48),48));
        }
    }
    ...
    public static UInt128 Combine(UInt128 t1,UInt128 t2,UInt128 t3,UInt128 t4)
    {
        unsafe
        {
            ...
            return ToUint128(xxHash128.ComputeHash(new Span<byte>(pointer,64),64));
        }
    }
    ...
    public static UInt128 Combine(UInt128 t1, UInt128 t2,UInt128 t3,UInt128 t4,UInt128 t5)
    {
        unsafe
        {
            ...
            return ToUint128(xxHash128.ComputeHash(new Span<byte>(pointer,80),80));
        }
    }
    ...
    public static UInt128 Combine(UInt128 t1, UInt128 t2,UInt128 t3,UInt128 t4,UInt128 t5,UInt128 t6)
    {
        unsafe
        {
            ...
            return ToUint128(xxHash128.ComputeHash(new Span<byte>(pointer,96),96));
        }
    }
    ...
    public static UInt128 Combine(UInt128 t1, UInt128 t2,UInt128 t3,UInt128 t4,UInt128 t5,UInt128 t6,UInt128 t7)
    {
        unsafe
        {
            ...
            return ToUint128(xxHash128.ComputeHash(new Span<byte>(pointer,112),112));
        }
    }
        ...
        UInt128 t8)
    {
        unsafe
        {
            ...
            return ToUint128(xxHash128.ComputeHash(new Span<byte>(pointer,128),128));
        }
    }
    ...
    where T : struct
    {
        unsafe
        {
            ...
            return ToUint128(xxHash128.ComputeHash(span,size));
        }
    }
